...
CQA.data.registerPack({
  ...
  questions: [
    ...
    },
	{
	  ...
	  options: [
		"A set of free usage offers and credits that let you try selected AWS services within defined limits",
	  ...
	  correctAnswer: 0,
	  explanation:
		"AWS Free Tier includes multiple offer types, including always-free services, short-term trials, and free-plan credits for new customers. Usage is limited, and charges apply if you exceed the applicable limits or use paid features beyond the free allowances.",
	  resourceTitle: "AWS Free Tier",
	  resourceUrl: "https://aws.amazon.com/free/",
	  keywords: ["AWS Free Tier", "usage limits", "credits", "always free"],
	  tooltipTerms: [],
	},	
    {
      id: "xp-cst-b3",
